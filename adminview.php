...
<div class="panel-heading">
    <h1 style="text-align: center;padding: 50px;">Attendance</h1>
</div>
<form method="post">
<div  class="plain body">
<input type="text" name="username"  id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="DD-MM-YY">
<button type="submit" class="btn btn-primary" style="margin:10px;">Show Result</button>
 ...
 <table class="table">
  ...
  <?php
    ...
    $query="select * from attendence WHERE date='$username'";
...
<a class="btn btn-primary" href="adminhomepage1.php" role="button" style="width:150px; float:middle ;">Back</a>
</form> 
</div>
</div>
    <!-- Optional JavaScript -->
